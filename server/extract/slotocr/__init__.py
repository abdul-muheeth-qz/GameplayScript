...
normalized box per game layout, listed in slotocr.roi_config, and the crop is
then OCR'd. See slotocr.pipeline.process_image for the full per-image flow and
slotocr.roi for how the box is chosen.
"""
